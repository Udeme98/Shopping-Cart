  ...
  return (
    <nav className="p-7 shadow-md bg-blue-400">
      <div className="container mx-auto flex items-center justify-between">
        ...
        >
          {menuOpen ? (
            <FaTimes className="font-bold text-red-800 text-4xl cursor-pointer hover:text-red-500  transition duration-300" />
          ) : (
            <FaBars className="font-bold text-red-800 text-4xl cursor-pointer hover:text-red-500  transition duration-300" />
          )}
        </button>
      </div>
    </nav>
